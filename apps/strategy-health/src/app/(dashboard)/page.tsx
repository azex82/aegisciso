...
import { Target, Rocket, LineChart, TrendingUp, CheckCircle, AlertTriangle, Clock } from 'lucide-react';
...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <div><h2 className="text-2xl font-bold tracking-tight">Strategy Dashboard</h2><p className="text-muted-foreground">Track security strategy objectives and initiatives</p></div>
